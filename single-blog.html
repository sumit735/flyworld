...
<!-- Mirrored from pixner.net/emigrar/emigrar/single-blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2019 06:16:29 GMT -->
<head>
    <meta charset="utf-8">
...
<section class="blog-content-area">
    ...
    <a href="#" class="post-thumbnail">
        <img src="assets/images/all-img/single-post-1.jpg" alt="">
        <div class="meta-date">
            <span>22</span>
            <span>Dec</span>
        </div><!-- /.meta-date -->
    ...
    <div class="entry-content">
        ...
        <div class="row">
           ...
           <div class="col-lg-4 offset-lg-1">
                <figure>
                    <img src="assets/images/all-img/post-inner.jpg" alt="">
                </figure>
           </div><!-- /.col-lg-4 -->
    ...
    <ol class="comment-list">
            ...
            <div id="div-comment-4" class="comment-body">
                <footer class="comment-meta">
                    <div class="comment-author vcard">
                        <img src="assets/images/all-img/cmnt-1.jpg" class="avatar" alt="comment user">
            ...
            <ol class="children">
                <li class="comment even thread-even depth-1">
                    <div class="comment-body">
                        <footer class="comment-meta">
                            <div class="comment-author vcard">
                                <img src="assets/images/all-img/cmnt-2.jpg" class="avatar" alt="comment user">
        ...
        <li class="comment odd alt thread-odd thread-alt depth-1">
            <div id="div-comment-3" class="comment-body">
                <footer class="comment-meta">
                    <div class="comment-author vcard">
                        <img alt="" src="assets/images/all-img/cmnt-3.jpg" class="avatar  photo">
...
<!-- Mirrored from pixner.net/emigrar/emigrar/single-blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2019 06:16:32 GMT -->
</html>

...
<!-- Mirrored from pixner.net/emigrar/emigrar/index-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2019 06:10:32 GMT -->
<head>
    <meta charset="utf-8">
...
<div class="rt-preloder">
    ...
    <div class="container">
        ...
        <div class="main-header rt-sticky">
            <nav class="navbar">
                <div class="container">
                    <a href="index-2.html" class="brand-logo"><img src="assets/images/logo/logo-white.png" alt=""></a>
...
<section class="rt-banner-area">
    <div class="single-rt-banner rt-banner-height rt-dark" style="background-image: url(assets/images/all-img/banner02.png)">
        <div class="container">
...
<div class="rt-banner-searchbox dark-search wow fade-in-bottom" data-wow-duration="1s" data-wow-delay="1s">
    <div class="tab-content" id="myTabContent">
            ...
            <form action="#">
                ...
                <div class="rt-input-group">
                    <div class="single-input  col-rt-in-3">
                        ...
                        <span class="input-iconbadge"><img src="assets/images/icons-image/s_icon_3.png" alt=""
                    ...
                    <div class="single-input  col-rt-in-3">
                        ...
                        <span class="input-iconbadge"><img src="assets/images/icons-image/s_icon_4.png" alt=""
                                draggable="false"></span>
                    </div><!-- /.single-input -->
                    <div class="single-input  col-rt-in-3">
        ...
        <div class="tab-pane  rtIncative" id="rt-item_a_second" role="tabpanel"
...
<ul class="nav serachnavs wow fade-in-bottom dark-search-nav" id="rtMultiTab" role="tablist" data-wow-duration="1.5s"
    data-wow-delay="1.5s">
    <li class="nav-item">
...
<!-- 
    ========= Counter Start ========================
 -->
<div class="counter-area rt-dark">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
    <div class="media counter-box-1 align-items-center wow fadeInUp dark-box">
...
<div class="col-lg-4 col-md-6 col-12">
    <div class="media counter-box-1 align-items-center wow fadeInUp dark-box" data-wow-duration="1.5s">
...
<div class="col-lg-4 col-md-6 col-12">
    <div class="media counter-box-1 align-items-center wow fadeInUp dark-box" data-wow-duration="2s">
        <img src="assets/images/counter-icons/counter_iocn_1.png" alt="counter_iocn" draggable="false">
        <div class="media-body">
            <h5>Trusted Members</h5>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 mx-auto text-center">
                <div class="services-box-1 dark-box wow fade-in-bottom">
                    <div class="services-thumb">
                        <img src="assets/images/service-icons/s_icon_8.png" alt="" draggable="false">
                    </div><!-- /.services-thumb -->
                    <h4>Accommodation</h4>
                    <p>No matter where you are travelling, Emigrar is here to help you get the best deals in Hotels
                        around the world.</p>
                </div><!-- /.services-box-1 -->
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4 col-md-6 mx-auto text-center">
                <div class="services-box-1 dark-box wow fade-in-bottom" data-wow-duration="1.5s"> 
                    <div class="services-thumb">
                        <img src="assets/images/service-icons/s_icon_9.png" alt="" draggable="false">
                    </div><!-- /.services-thumb -->
                    <h4>Transportation</h4>
                    <p>Whether you are travelling through Air, Sea or Land, Emigrar can arrange transportation according
                        to.</p>
                </div><!-- /.services-box-1 -->
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4 col-md-6 mx-auto text-center">
                <div class="services-box-1 dark-box wow fade-in-bottom" data-wow-duration="2s">
                    <div class="services-thumb">
                        <img src="assets/images/service-icons/s_icon_10.png" alt="" draggable="false">
                    </div><!-- /.services-thumb -->
                    <h4>Expert Trip Planning</h4>
                    <p>Our Talented and Expert Trip Planning Team can make itinerary that suits our clients the best. We
                        will make your travel</p>
                </div><!-- /.services-box-1 -->
            </div><!-- /.col-lg-4 -->
        </div><!-- /.row -->
    </div><!-- /.container -->
...
<!-- 
    ============Deal Area Start===============
 -->
<section class="deal-area   rtbgprefix-full bg-hide-md rt-dark" style="background-image: url(assets/images/backgrounds/bgshapes_1.png)">
                ...
                <div class="col-lg-5">
                    <div class="deal-bg" style="background-image: url(assets/images/all-img/deal-bg.jpg)">
                        <div class="inner-content">
                            <h4 data-animation="fadeInDown" data-duration=".2s" data-delay=".4s">14 Day Classic Tour of
                                Thailand & Beaches</h4>
                            <p data-animation="fade-in-bottom" data-duration=".2s" data-delay=".4s">Grab a promo code for
                                extra savings up to 75% on discounted hotels!</p>
                        </div><!-- /.inner-content -->
                    </div><!-- /.deal-bg -->
                </div><!-- /.col-md-6 -->
                <div class="col-lg-7">
                    <div class="rt-section-title-wrapper text-white" data-animation="fadeIn" data-duration=".4s">
                        ...
                        <div class="deal-bottom-content">
                            <div class="rating-box">
                                ...
                                <span class="d-block"> <i class="fas fa-star"></i><i class="fas fa-star"></i><i
                            ...
                            <p>
                                Thailand is the perfect destination for those who love to spend time outdoors. You can
                                soak up the
                                sunshine on the beautiful beaches of Phuket, or head to the North of the country to
                                Chiang Mai for adventure and
                                outdoor
                                activities like water rafting and trekking. Of course, not to be missed is Bangkok,
                                where you can tour its
                                floating
...
<!-- 
    ========works start==========
 -->
<div class="spacer-top rt-dark"></div><!-- /.spacer-top -->
<section class="works-area rt-dark">
    <div class="container">
        <div class="row">
            <div class="col-xl-10 text-center mx-auto text-center">
                <div class="rt-section-title-wrapper text-white2">
                    ...
                    <p>Prepare For Your Trip.Find out all you need to know before you go.Traveling is as unique as you
                        are. And there is no one
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 mx-auto text-center">
                <div class="services-box-2 dark-box wow fade-in-bottom">
                    <div class="services-thumb">
                        <img src="assets/images/service-icons/s_icon_11.png" alt="service-icons" draggable="false">
                    </div><!-- /.services-thumb -->
            ...
            <div class="col-lg-3 col-md-6 mx-auto text-center">
                <div class="services-box-2 dark-box wow fade-in-bottom" data-wow-duration="1s">
                    <div class="services-thumb">
                        <img src="assets/images/service-icons/s_icon_12.png" alt="service-icons" draggable="false">
                    </div><!-- /.services-thumb -->
                    <span class="inner-counter"></span>
                    <h4>Compare & Book</h4>
            ...
            <div class="col-lg-3 col-md-6 mx-auto text-center">
                <div class="services-box-2 dark-box wow fade-in-bottom" data-wow-duration="1.5s">
                    <div class="services-thumb">
                        <img src="assets/images/service-icons/s_icon_13.png" alt="service-icons" draggable="false">
                    </div><!-- /.services-thumb -->
                    <span class="inner-counter"></span>
            ...
            <div class="col-lg-3 col-md-6 mx-auto text-center">
                <div class="services-box-2 dark-box wow fade-in-bottom" data-wow-duration="2s">
                    <div class="services-thumb">
                        <img src="assets/images/service-icons/s_icon_14.png" alt="service-icons" draggable="false">
                    </div><!-- /.services-thumb -->
                    <span class="inner-counter"></span>
                    <h4>Book a room</h4>
            ...
            <div class="col-12 text-center mt-4">
                <a href="#" class="rt-btn rt-gradient text-uppercase rt-sm rt-Bshadow-2 rt-rounded">Tour the world</a><!-- /.rt-btn -->
            </div><!-- /.col-12 -->
        </div><!-- /.row -->
    </div><!-- /.container -->
</section>
...
<div class="spacer-top rt-dark"></div><!-- /.spacer-top -->
<section class="portfolio-area rt-section-padding rtbgprefix-full rt-dark bg-hide-md gradinet-bg-md" style="background-image: url(assets/images/backgrounds/portfoliobg.png)">
    <div class="container">
        <div class="row">
        ...
        <div class="row grid">
            <div class="col-lg-4 col-md-6 grid-item cat-1 cat-5 cat-4">
                <div class="portfolio-box-1 wow fade-in-bottom "
                    style="background-image: url(assets/images/portfolio/port-1.jpg)">
            ...
            <div class="col-lg-4 col-md-6 grid-item cat-2 cat-3 cat-5">
                <div class="portfolio-box-1 wow fade-in-bottom "
                    style="background-image: url(assets/images/portfolio/port-2.jpg)" data-wow-duration="1s">
                    <div class="rt-overlay"></div><!-- /.rt-overlay -->
                    <div class="portfolio-badge">
                        <span>From</span>
                        <span><sup>$</sup>239</span>
            ...
            <div class="col-lg-4 col-md-6 grid-item cat-1 cat-4">
                <div class="portfolio-box-1 wow fade-in-bottom "
                    style="background-image: url(assets/images/portfolio/port-3.jpg)" data-wow-duration="1.3s">
                    <div class="rt-overlay"></div><!-- /.rt-overlay -->
                    <div class="portfolio-badge">
                        <span>From</span>
                        <span><sup>$</sup>239</span>
            ...
            <div class="col-lg-4 col-md-6 grid-item cat-4 cat-3 cat-5">
                <div class="portfolio-box-1 wow fade-in-bottom "
                    style="background-image: url(assets/images/portfolio/port-4.jpg)" data-wow-duration="1.6s">
                    <div class="rt-overlay"></div><!-- /.rt-overlay -->
                    <div class="portfolio-badge">
                        <span>From</span>
                        <span><sup>$</sup>239</span>
            ...
            <div class="col-lg-4 col-md-6 grid-item cat-1 cat-5">
                <div class="portfolio-box-1 wow fade-in-bottom "
                    style="background-image: url(assets/images/portfolio/port-5.jpg)" data-wow-duration="1.9s">
                    <div class="rt-overlay"></div><!-- /.rt-overlay -->
                    <div class="portfolio-badge">
                        <span>From</span>
                        <span><sup>$</sup>239</span>
            ...
            <div class="col-lg-4 col-md-6 grid-item cat-3 cat-5">
                <div class="portfolio-box-1 wow fade-in-bottom "
                    style="background-image: url(assets/images/portfolio/port-6.jpg)" data-wow-duration="2.2s">
                    <div class="rt-overlay"></div><!-- /.rt-overlay -->
                    <div class="portfolio-badge">
                        <span>From</span>
                        <span><sup>$</sup>239</span>
...
<section class="flight-dela-area rt-dark" data-scrollax-parent="true">
    ...
    <div class="rt-shape-emenetns-2" style="background-image: url(assets/images/shape-elements/shape-2.png)"
        data-scrollax="properties: { translateX: '-40px' }"></div><!-- /.rt-shape-elemenets2 -->
    <div class="container">
        <div class="row">
        ...
        <div class="row">
            <div class="col-xl-8 col-lg-10">
                <div class="row">
                    <div class="col-md-6">
                        <a class="flight-box dark-box wow fade-in-bottom" data-wow-duration="1s" data-wow-delay=".02s" href="#"  style="background-image: url(assets/images/flights/flt_1.jpg)">
                    ...
                    <div class=" col-md-6">
                        <a class="flight-box dark-box wow fade-in-bottom" data-wow-duration="1.3s" data-wow-delay=".04s" href="#" style="background-image: url(assets/images/flights/flt_2.jpg)">
                    ...
                    <div class="col-md-6">
                        <a class="flight-box dark-box wow fade-in-bottom" data-wow-duration="1.6s" data-wow-delay=".06s" href="#" style="background-image: url(assets/images/flights/flt_3.jpg)">
                    ...
                    <div class="col-md-6">
                        <a class="flight-box dark-box wow fade-in-bottom" data-wow-duration="1.9s" data-wow-delay=".08s" href="#" style="background-image: url(assets/images/flights/flt_4.jpg)">
                    ...
                    <div class="col-md-6">
                        <a class="flight-box dark-box wow fade-in-bottom" data-wow-duration="2.1s" data-wow-delay=".08s" href="#" style="background-image: url(assets/images/flights/flt_5.jpg)">
                    ...
                    <div class="col-md-6">
                        <a class="flight-box dark-box wow fade-in-bottom" data-wow-duration="2.4s" data-wow-delay=".9s"href="#" style="background-image: url(assets/images/flights/flt_6.jpg)">
...
<div class="spacer-top rt-dark"></div><!-- /.spacer-top -->
<section class="rt-cta-area rt-dark">
...
<section class="app-area rtbgprefix-cover rt-dark" style="background-image: url(assets/images/backgrounds/app_bg.png)"
...
<div class="play-video rtbgprefix-full rt-dark bg-hide-md" style="background-image: url(assets/images/backgrounds/videobg2.png)">
    <div class="container">
        <div class="row">
...
<section class="testimonials-area rt-dark rt-light-text" data-scrollax-parent="true">
    <div class="rt-shape-emenetns-1" style="background-image: url(assets/images/shape-elements/shape-5.png)"
        data-scrollax="properties: { translateY: '-140px' }"></div><!-- /.rt-shape-emenetns-1 -->
    <div class="container">
        <div class="row">
    ...
    <div class="singleTbox-1 text-center inactive position-10" data-position="position-10">
        ...
        <div class="rt-divider style-two rt-margin-top"></div><!-- /.divider -->
    </div><!-- /.containe -->
</section>
...
<div class="spacer-top rt-dark"></div><!-- /.spacer-top -->
<section class="brands-area rt-dark">
    <div class="container">
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-9 mx-auto">
                <ul class="rt-border-brands dark-box">
    ...
    <li class="single-border-brands">
        <a href="#" class="wow flipInX d-block" data-wow-duration="1.5s">
            <img src="assets/images/brands/brands-7.png" alt="brands image" draggable="false">
        </a>
    </li><!-- /.single-border-brands -->
    <li class="single-border-brands">
        <a href="#" class="wow flipInX d-block" data-wow-duration="2s">
            <img src="assets/images/brands/brands-8.png" alt="brands image" draggable="false">
        </a>
    </li><!-- /.single-border-brands -->
    <li class="single-border-brands">
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-10 mx-auto text-center">
                        <div class="rt-section-title-wrapper text-white">
                            ...
                            <p>
                                Get the latest travel inspirations and deals from Emigrar semimonthly with your email.
                                You can
            ...
            <div class="row">
                ...
                <div class="col-lg-6 text-center text-lg-right">
                    <div class="rt-footer-social">
                        <ul>
                            <li><a href="#"><img src="assets/images/brands/card-1.png" alt="cardimage"
                                        draggable="false"></a></li>
                            <li><a href="#"><img src="assets/images/brands/card-2.png" alt="cardimage"
                                        draggable="false"></a></li>
                            <li><a href="#"><img src="assets/images/brands/card-3.png" alt="cardimage"
                                        draggable="false"></a></li>
                            <li><a href="#"><img src="assets/images/brands/card-4.png" alt="cardimage"
                                        draggable="false"></a></li>
                            <li><a href="#"><img src="assets/images/brands/card-5.png" alt="cardimage"
                                        draggable="false"></a></li>
...
<!-- Mirrored from pixner.net/emigrar/emigrar/index-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2019 06:10:52 GMT -->
</html>

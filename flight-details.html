...
<!-- Mirrored from pixner.net/emigrar/emigrar/flight-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2019 06:15:28 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="col-xl-9 mx-auto col-lg-10">
                ...
                <div class="flt-dtls-box rt-mb-30">
                    <div class="upper-top-content d-md-flex flex-md-row justify-content-md-between align-items-center">
                        <div class="left">
                            <span>Hong Kong</span> <span><img src="assets/images/all-img/shp-ln-1.png" alt="line image" draggable="false"></span> <span>Singapore</span>
                            ...
                            <div class="col-lg-6 rt-mb-30">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control rt-date-picker" placeholder="date" id="st-date">
                                    </div><!-- /.col-md-6 -->
                                </div><!-- /.row -->
                            </div><!-- /.col-md-6 -->
                            <div class="col-md-6 rt-mb-30">

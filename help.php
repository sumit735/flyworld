...
<!-- Mirrored from pixner.net/emigrar/emigrar/help.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2019 06:16:45 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 mx-auto text-center">
                <div class="services-box-2 wow fade-in-bottom">
                    <div class="services-thumb">
                        <img src="assets/images/all-img/help-icon-1.png" alt="service-icons" draggable="false">
                    </div><!-- /.services-thumb -->
            ...
            <div class="col-lg-3 col-md-6 mx-auto text-center">
                <div class="services-box-2 wow fade-in-bottom" data-wow-duration="1s">
                    <div class="services-thumb">
                        <img src="assets/images/all-img/help-icon-2.png" alt="service-icons" draggable="false">
                    </div><!-- /.services-thumb -->
                    <h4>FAQ</h4>
                </div><!-- /.services-box-2 -->
            </div><!-- /.col-lg-3 -->
            <div class="col-lg-3 col-md-6 mx-auto text-center">
                <div class="services-box-2 wow fade-in-bottom" data-wow-duration="1.5s">
                    <div class="services-thumb">
                        <img src="assets/images/all-img/help-icon-3.png" alt="service-icons" draggable="false">
                    </div><!-- /.services-thumb -->
                    <h4>Contact Us</h4>
                </div><!-- /.services-box-2 -->
            </div><!-- /.col-lg-3 -->
            <div class="col-lg-3 col-md-6 mx-auto text-center">
                <div class="services-box-2 wow fade-in-bottom" data-wow-duration="2s">
                    <div class="services-thumb">
                        <img src="assets/images/all-img/help-icon-4.png" alt="service-icons" draggable="false">
                    </div><!-- /.services-thumb -->
                    <h4>Meet The Team</h4>
                </div><!-- /.services-box-2 -->
            </div><!-- /.col-lg-3 -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <h4 class="f-size-40 rt-semibold rt-mb-40 f-size-md-32 f-size-xs-26">Didn't find what You were looking for?</h4>
                <a href="#" class="rt-btn rt-gradient rt-rounded rt-sm text-uppercase">Submit your query</a>
            </div><!-- /.col-12 -->
        </div><!-- /.row -->
    </div><!-- /.container -->
</section>
...
<section class="about-area2">
    ...
    <div class="card wow fade-in-bottom">
        <div class="card-header card-primary" id="headingOne">
            <h5 class="mb-0">
                <button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true"
                    ...
                    <span class="d-inline-block f-size-18 rt-hw-40 bg-gradient-primary rt-circle rt-mr-10 text-center text-white"><i class="icofont-question"></i></span>What are the possible reasons for my credit card declining?
                </button>
            </h5>
        </div>
        ...
        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
            <div class="card-body">
                You are welcome to make deposits or partial payments for your reservation, but until
                Emigrarreceives full payment for your reservation, your seats will not be secured. Please make your complete payment as
                soon as possible.
            </div>
        </div>
    ...
    <div class="card wow fade-in-bottom" data-wow-duration="1.0s">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
            <div class="card-body">
                Landing Page Builder is a hosted platform powered by the Brizy builder aiming to connect you with p
                otential clients,
    ...
    <div class="card wow fade-in-bottom" data-wow-duration="1.5s">
        <div class="card-header card-primary" id="headingThree2">
            <h5 class="mb-0">
                ...
                <span class="d-inline-block f-size-18 rt-hw-40 bg-gradient-primary rt-circle rt-mr-10 text-center text-white"><i
                        class="icofont-question"></i></span> How do I search for a hotel in a certain area using the map tool?
                </button>
            </h5>
        </div>
    ...
    <div class="card wow fade-in-bottom" data-wow-duration="1.5s">
        <div class="card-header card-primary" id="headingThree21">
            <h5 class="mb-0">
                ...
                <span class="d-inline-block f-size-18 rt-hw-40 bg-gradient-primary rt-circle rt-mr-10 text-center text-white"><i
                        class="icofont-question"></i></span> How can I make a booking?
                </button>
            </h5>
        </div>
...
<!-- Mirrored from pixner.net/emigrar/emigrar/help.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2019 06:16:48 GMT -->
</html>

...
<section class="404-content-area">
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <img src="assets/images/all-img/404.png" alt="404 image" class="rt-mb-30" draggable="false">
                    <h3 class="rt-semiblod rt-mb-15">
                        Oops... It looks like you ‘re lost !
                    </h3>
                    <p class="rt-mb-30">The page you were looking for dosen’t exist.</p>
                    <a href="#" class="rt-btn rt-gradient pill text-uppercase">GO BACK</a>
            </div><!-- ./column -->
        </div><!-- ./row -->
    </div><!-- ./ copntainer -->
</section>

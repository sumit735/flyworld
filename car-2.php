...
<!-- Mirrored from pixner.net/emigrar/emigrar/car-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2019 06:15:56 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="col-xl-9">
                ...
                <div class="flt-dtls-box rt-mb-30">
                    <div class="upper-top-content d-md-flex flex-md-row justify-content-md-between align-items-center">
                        ...
                        <div class="right">
                            <a href="#" class="rt-btn rt-outline-light   pill text-uppercase rt-sm2 rt-mr-5">Important Information</a>
                    ...
                    <div class="flight-list-box rt-mb-30">
                        <div class="top-content d-flex flex-lg-row flex-column justify-content-lg-between">
                            <div class="car-thumb">
                            ...
                            <div class="economy">
                                ...
                                <span class="d-block text-444 rt-mb-5"> <span><i class="icofont-wheelchair"></i> 4</span> <span><i
                                            class="icofont-briefcase"></i> 2</span></span>
                            ...
                            <div class="price-mant text-lg-right">
                                ...
                                <a href="#" class="rt-btn rt-gradient pill rt-sm3 text-uppercase rt-mt-10">Select</a>
                            </div><!-- /.price-mant -->
                        </div><!-- /.top-content -->

...
<!-- Mirrored from pixner.net/emigrar/emigrar/how-work.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2019 06:16:48 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                <div class="rt-section-title-wrapper">
                    <h2 class="rt-section-title"><span>How it works</span>
                    Easy to begin</h2>
                    <p>You handle the booking. We take care of the rest.</p>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 mb-0 mb-md-4">
                ...
                <img src="assets/images/all-img/work-img-1.png" alt="work image" draggable="false">
            </div><!-- /.col-lg-6 -->
            <div class="col-lg-5 offset-lg-1 mb-0 mb-md-4">
                ...
                <h4 class="f-size-24 rt-semiblod rt-mb-20">Choose your destination</h4>
                <div class="text-424">
                    <p class="f-size-14 ">View hundreds of holidays online. Travel alone or take the family.
                        It’s all up to you. Choose where you want to stay then click the Book Now button to check dates and make your
                        reservation.One of our friendly customer service team members will get back to you to discuss the details and ensure
                        reservation goes smoothly.</p>
                </div><!-- /.text-424 -->
        ...
        <div class="row align-items-center">
            <div class="col-lg-5 mb-0 mb-md-4">
                ...
                <h4 class="f-size-24 rt-semiblod rt-mb-20">Select your options</h4>
                <div class="text-424">
                    <p class="f-size-14 ">Choose your departure date from 5 to 24 months in advance.
                    Add spending money?.You can choose from various payment
                    methods for your flight reservation and extra services (e.g. seats, extra baggage etc.), depending on the country in
                    which the booking takes place and the time of the booking. But whichever method you choose, you can rest assured that
                    your payment is always safe.</p>
                </div><!-- /.text-424 -->
            ...
            <div class="col-lg-6 offset-lg-1">
                ...
                <img src="assets/images/all-img/work-img-2.png" alt="work image" draggable="false">
            </div><!-- /.col-lg-6 -->
        </div><!-- /.row -->
        <div class="row align-items-center">
            <div class="col-lg-6 mb-0 mb-md-4">
                ...
                <img src="assets/images/all-img/work-img-3.png" alt="work image" draggable="false">
            </div><!-- /.col-lg-6 -->
            <div class="col-lg-5 offset-lg-1">
                <div class="rt-icon rt-hw-65 f-size-45  rt-dotted-primary text-gradinet-primary rt-mb-30">
                    <i class="icofont-runner-alt-1"></i>
                </div><!-- /.rt-icon -->
                <h4 class="f-size-24 rt-semiblod rt-mb-20">Get Confirm and Enjoy</h4>
                <div class="text-424">
                    <p class="f-size-14 ">We’d love to kick off the planning for your next special vacation! Please click below to contact us and schedule an
                    initial call.We have the knowledge, experience, and expertise to
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-10 mx-auto text-center">
                <div class="rt-section-title-wrapper">
                    <h2 class="rt-section-title"><span>It's safe!</span>
                    
                    Security is our top priority</h2>
                    <p>Security is a top priority for us .We work to protect your personal information by using appropriate and generally
                    accepted safeguards, procedures, and practices for both physical and online security..</p>
                </div><!-- /.rt-section-title-wrapper -->
            </div><!-- /.col-lg-8 -->
        </div><!-- ./row -->
        <div class="section-title-spacer"></div><!-- /.section-title-spacer -->
        <div class="row align-items-center">
            <div class="col-lg-5 mb-0 mb-md-4">
                <div class="icon-thumb rt-mb-30">
                    <img src="assets/images/all-img/iconx-1.png" alt="icon-image" draggable="false">
                </div><!-- /.icon-thumb --> 
                <h4 class="f-size-24 rt-semiblod rt-mb-20">Personalized Support</h4>
                <div class="text-424">
                    <ul class="rt-list">
                        <li><span class="rt-pr-4"><i class="icofont-check-circled"></i></span> Emigrar will handle the mediation between the
                            host and the guest in cases of
                            incident or damage.</li>
                        <li><span class="rt-pr-4"><i class="icofont-check-circled"></i></span>Emigrar will find a personalized solution to
                            resolve the issue.</li>
                    
                        <li><span class="rt-pr-4"><i class="icofont-check-circled"></i></span>Emigrar will compensate you in case of any
                            unforeseen incident or damages.</li>
                    </ul>
                </div><!-- /.text-424 -->
                <a href="#" class="rt-btn rt-gradient rt-rounded text-uppercase rt-sm rt-mt-25">Submit your query</a>
        
            </div><!-- /.col-lg-6 -->
            <div class="col-lg-6 offset-lg-1">
                <img src="assets/images/all-img/work-img-4.png" alt="work image" draggable="false">
            </div><!-- /.col-lg-6 -->
        </div><!-- /.row -->
        <div class="section-title-spacer"></div><!-- /.section-title-spacer -->
        <div class="row align-items-center">
            <div class="col-lg-6 mb-0 mb-md-4">
                ...
                <img src="assets/images/all-img/work-img-5.png" alt="work image" draggable="false">
            </div><!-- /.col-lg-6 -->
            <div class="col-lg-5 offset-lg-1">
                <div class="icon-thumb rt-mb-30">
                    <img src="assets/images/all-img/iconx-2.png" alt="icon-image" draggable="false">
                </div><!-- /.icon-thumb -->
                <h4 class="f-size-24 rt-semiblod rt-mb-20">Damage Protection</h4>
                <div class="text-424">
                    <ul class="rt-list">
                        <li><span class="rt-pr-4"><i class="icofont-check-circled"></i></span> Emigrar will handle the mediation between the host and the guest in cases of
                        incident or damage.</li>
                       <li><span class="rt-pr-4"><i class="icofont-check-circled"></i></span>Emigrar will find a personalized solution to resolve the issue.</li>
                      
                       <li><span class="rt-pr-4"><i class="icofont-check-circled"></i></span>Emigrar will compensate you in case of any unforeseen incident or damages.</li>
                    </ul>
                </div><!-- /.text-424 -->
                <a href="#" class="rt-btn rt-gradient rt-rounded text-uppercase rt-sm rt-mt-25">Read more</a>
...
<!-- Mirrored from pixner.net/emigrar/emigrar/how-work.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2019 06:16:54 GMT -->
</html>

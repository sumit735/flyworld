...
<?php 
  ...
  if(isset($_POST['add'])) {
    ...
    $image = $_FILES['image']['name'];
  	...
  	$sql = "INSERT INTO `featured_international` (`name`, `details`, `image`, `price`) VALUES ('$name', '$details', '$target', '$price')";
  	// execute query
        ...
        <div class="row">
            ...
            <div class="col-xl-9">
                ...
                <div class="flight-list-box rt-mb-30 pt-30">
                    ...
                    ?>
                    <h4 class="f-size-24 text-capitalize rt-mb-30  rt-semiblod">Feature International Tour</h4>

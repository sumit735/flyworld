...
<!-- Mirrored from pixner.net/emigrar/emigrar/trip-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2019 06:15:55 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="flight-list-box">
                        <div class="hotel-inner-content row">
                            <div class="hotel-thumb col-md-3">
                                <div class="hotel-bg rtbgprefix-cover"
                                    style="background-image: url(assets/images/all-img/hotel-2.jpg)">
                            ...
                            <div class="hotel-text col-md-9">
                                ...
                                <div class="footer3-elements rt-mt-20">
                                    <span class="d-block heading-color-1 rt-strong">Superior Room - Minimum 2
                                        nights</span>

                                    <div class="clearfix f-size-12 text-555"><span class="float-left ">Max. guests per
                                            room</span> <span class="float-right">02</span></div>
                                    <div class="clearfix f-size-12 text-555"><span class="float-left">Bed</span> <span
                                            class="float-right">1 double bed or 2 single beds</span></div>
                                    <div class="clearfix f-size-12 text-555"><span class="float-left">Breakfast</span>
                                        <span class="float-right">No Breakfast</span></div>
